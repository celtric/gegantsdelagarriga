...
import MussoletRicard from "../../public/mussolet-ricard.jpg";
...
import PintatMussolet6 from "../../public/pintat-mussolet-6.jpg";
import PintatMussolet7 from "../../public/pintat-mussolet-7.jpg";
import PintatMussolet8 from "../../public/pintat-mussolet-8.jpg";
import PintatMussolet9 from "../../public/pintat-mussolet-9.jpg";
...
Segurament heu arribat a aquesta pàgina seguint un codi QR d'una figura que heu rebut. Benvinguts! Segurament, a més, us
agradaria saber com el podeu pintar. Començarem primer per aquesta part, i si voleu saber més sobre la iniciativa (com
es va fer, com els hem imprès, etc.) ho podeu trobar també en aquesta pàgina, una mica més a sota.
...
petit possible pels detalls) i molt paciència. És probable que un adult necessiti ajudar amb aquests detalls més petits.
...
Finalment, us recomanem que apliqueu una capa de vernís protector per evitar que la pintura acabi saltant amb l'ús.
...
<Grid container spacing={2}>
  ...
  <Grid item xs={12} md={4}>
    <Link href="/pintat-mussolet-6.jpg" target="_blank">
      <FullSizeImage image={PintatMussolet6} alt="Procés de pintat del Mussolet" mb={0} width={300} />
    </Link>
  </Grid>
  <Grid item xs={12} md={4}>
    <Link href="/pintat-mussolet-7.jpg" target="_blank">
      <FullSizeImage image={PintatMussolet7} alt="Procés de pintat del Mussolet" mb={0} width={300} />
    </Link>
  </Grid>
  <Grid item xs={12} md={4}>
    <Link href="/pintat-mussolet-8.jpg" target="_blank">
      <FullSizeImage image={PintatMussolet8} alt="Procés de pintat del Mussolet" mb={0} width={300} />
    </Link>
  </Grid>
  <Grid item xs={12} md={4}>
    <Link href="/pintat-mussolet-9.jpg" target="_blank">
      <FullSizeImage image={PintatMussolet9} alt="Procés de pintat del Mussolet" mb={0} width={300} />
    </Link>
  </Grid>
</Grid>
...
<Grid container spacing={2}>
  ...
  <Grid item xs={12}>
    <ImageListItem sx={{"& img": {display: "block", height: "auto"}}}>
      <Image src={MussoletRicard} alt="El Mussolet pintat pel Ricard" />
      <ImageListItemBar title="El Mussolet pintat pel Ricard" position="bottom" />
    </ImageListItem>
  </Grid>
</Grid>
...
A principis de 2023 vam començar a estudiar la possibilitat de fer figures dels gegants pels nens i nenes del poble.
...
<Link href="https://ca.wikipedia.org/wiki/Fotogrametria" target="_blank">fotogrametria</Link>.

La primera part va consistir en fer unes 100 fotografies del mussolet. Amb l'aplicació Meshroom vam generar el model
"brut" a partir d'aquestes fotografies (descartant algunes fotografies per fer el model més acurat), i posteriorment vam
procedir a la neteja i allisat del model amb Blender.
